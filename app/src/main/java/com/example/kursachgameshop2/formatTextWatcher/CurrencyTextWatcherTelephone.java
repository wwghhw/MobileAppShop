...
public class CurrencyTextWatcherTelephone implements TextWatcher {
    ...
    private void applyFormat(String toString) {
        String template = getTemplateTelephone(toString);
        sb.setLength(0);
    ...
    private String getTemplateTelephone(String editText){
